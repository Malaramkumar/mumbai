      ...
      <div className="MEProjectDevelopmentCenter-main">
        <div className="MEProjectDevelopmentCenter-grid">
          ...
          <div className="MEProjectDevelopmentCenter-right">
            ...
            <ul>
              <li><a href="/multi-body-dynamics-simulation-mechanical-systems-project-development">Multi-Body Dynamics Simulation in Mechanical Systems Project Development</a></li>
