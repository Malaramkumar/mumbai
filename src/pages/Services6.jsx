...
import { BookOpenCheck, FileText, FilePenLine, Presentation } from "lucide-react";
    ...
    <section className="services6-wrapper">
      ...
      >
        ...
        <div className="services6-center-content">
          ...
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa rem animi velit
            tenetur eaque, deleniti culpa nam, vel architecto incidunt cum nesciunt sint,
            ea aperiam illo id vero odit iure dicta adipisci! Voluptatibus mollitia sunt
            obcaecati possimus quas, inventore, cupiditate laboriosam veniam maxime sit
            cumque, quaerat animi. Minus voluptates tenetur mollitia, numquam quam
            eligendi perferendis nihil eius quos magni, sed facilis! Debitis, nam in sunt
            dolorum, eum illum consequuntur vel vitae aspernatur suscipit velit ducimus
            recusandae? Facere consequatur nihil, quos omnis culpa expedita eveniet
            distinctio labore iste quod. Quis esse expedita tenetur laborum deleniti
            aliquam commodi delectus! Blanditiis, ipsum ullam.
          </p>
