...
import SEO from ".././assets/SEO"  // adjust path if needed
...
const CollegesList = () => {
  ...
  return (
    <div className="colleges-list-container">
      <SEO 
  title="PhD Universities in Maharashtra | Top Colleges List 2025"
  description="Explore the complete list of top PhD universities in Maharashtra, including Mumbai and Pune. Search colleges, find details, and access academic guidance by Narpavi Research Institute."
  url="/colleges"
  schemaType="WebPage"
/>
