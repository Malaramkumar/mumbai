        ...
        <div className="CSEProjectDevelopmentCenter-grid">
          ...
          <div className="CSEProjectDevelopmentCenter-left">
            ...
            <ul>
              ...
              <li>Industrial Automation Robotics Mumbai</li>
              <li>Autonomous Drone Projects Mumbai</li>
              <li>ROS Robotics Projects Mumbai</li>
              <li>Swarm Robotics Projects Mumbai</li>
              <li>B.Tech Robotics Projects Mumbai</li>
              <li>M.Tech Robotics Projects Mumbai</li>
              <li>Ph.D. Robotics Projects Mumbai</li>
              <li>Narpavi Technologies Robotics Project Development Center</li>
            </ul>
          </div>
