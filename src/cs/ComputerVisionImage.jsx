        ...
        <div className="CSEProjectDevelopmentCenter-grid">
          ...
          <div className="CSEProjectDevelopmentCenter-left">
            ...
            <ul>
              ...
              <li>image processing projects India</li>
              <li>IEEE video analytics projects</li>
              <li>medical image analysis projects</li>
              <li>object detection and segmentation projects</li>
              <li>AI computer vision research</li>
              <li>video surveillance projects Mumbai</li>
              <li>deep learning for image recognition</li>
              <li>autonomous vehicle vision projects</li>
              <li>machine vision for industry Mumbai</li>
            </ul>
          </div>
